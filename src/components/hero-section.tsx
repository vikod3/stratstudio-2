  ...
  return (
    <section className="relative min-h-screen px-6 md:px-12 lg:px-24 overflow-hidden flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto relative">
        {/* Hero Content */}
        <div className="relative z-20 flex-col text-center gap-7 my-0 flex items-center justify-end py-0 pt-[380px] pb-20">
          {/* Badge */}
          <GlowBadge>
          ...
          <div className="flex flex-col items-center gap-4">
            <BlurInHeading as="h1" className="max-w-[1000px] text-foreground font-medium leading-none text-[89px]">
