...
export const HeroSection = () => {
  ...
  return <section className="relative min-h-screen px-6 md:px-12 lg:px-24 overflow-hidden flex items-center justify-center">
      ...
      duration: 1.2,
      ease: "easeOut"
    }} className="absolute inset-0 w-full h-full pointer-events-none" style={{
      perspective: "1200px",
      ...
      top: "50%"
        ...
        <div className={prefersReducedMotion ? "" : "animate-spin-slow"}>
          ...
          zIndex: 0
            ...
            <img src={img3} alt="" className="w-full h-full object-cover opacity-50" />
          </div>
        </div>
        ...
        <div className={prefersReducedMotion ? "" : "animate-spin-slow-reverse"}>
          ...
          zIndex: 1
            ...
            <img src={img2} alt="" className="w-full h-full object-cover opacity-60" />
          </div>
        </div>
        ...
        <div className={prefersReducedMotion ? "" : "animate-spin-slow"}>
          ...
          zIndex: 2
            ...
            <img src={img1} alt="" className="w-full h-full object-cover opacity-80" />
          </div>
        </div>
      </motion.div>
        ...
        <div className="relative z-20 flex-col text-center gap-7 my-0 flex items-center justify-end py-0 pt-[240px] pb-20">
          ...
          <div className="flex flex-col items-center gap-0">
            <BlurInHeading as="h1" className="max-w-[800px] text-foreground leading-[0] tracking-[0] text-[76px]">
              <span className="font-inter-display py-0 px-0 text-9xl mx-0 text-center font-bold">Meet your new AI</span> <br className="hidden lg:block" /><span className="font-source-serif font-medium italic text-[76px]">Social Media Agency</span>
            </BlurInHeading>
            <motion.p initial={{
            opacity: 0,
            y: 20
          ...
          delay: 0.5,
          ease: "easeOut"
        }} onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-center gap-0 w-full max-w-md mb-8">
            <div className="flex w-full rounded-2xl overflow-hidden backdrop-blur-md bg-background/10 border border-white/20 shadow-lg">
              <Input type="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} className="flex-1 h-14 px-6 bg-transparent border-0 text-foreground placeholder:text-foreground/50 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-none" />
              <Button type="submit" variant="glass" size="lg" className="h-14 px-6 rounded-none rounded-r-2xl text-base shrink-0">
                Get Free Audit
      ...
      {/* Bottom Fade Effect */}
      <div className="absolute bottom-0 left-0 right-0 h-48 z-20 pointer-events-none" style={{
